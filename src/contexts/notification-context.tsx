				...
				<DropdownMenuLabel className="font-normal">
					<div className="flex flex-col space-y-1">
						<p className="text-sm font-medium leading-none">
							Notifications {/* Removed connection status from label */}
						</p>
						...
						notifications.map((notification: NotificationDTO) => {
							...
							if (entityId != null) {
								if (
									...
									entityType === "EQUIPMENT_RESERVATION_APPROVAL" ||
									entityType === "EQUIPMENT_RESERVATION_APPROVED" ||
									entityType === "EQUIPMENT_RESERVATION_REJECTED"
								) {
									canNavigate = true;
									targetPath = `/app/events/${entityId}`;
								} else if (entityType === "EQUIPMENT_RESERVATION_REQUEST") {
									canNavigate = true;
