		...
		<Card className="w-full max-w-md mx-auto shadow-lg">
			<CardHeader className="space-y-1">
				<div className="mx-auto bg-primary/10 p-3 rounded-full w-fit">
					{step === 1 && <KeyRound className="h-6 w-6 text-primary" />}
					{step === 2 && <Mail className="h-6 w-6 text-primary" />}
					{step === 3 && <LockKeyhole className="h-6 w-6 text-primary" />}
				</div>
				<CardTitle className="text-2xl font-bold text-center">
					Reset Password
				</CardTitle>
			...
			<CardContent>
				...
				{step === 2 && (
					<Form {...codeForm}>
						<form
							onSubmit={codeForm.handleSubmit(onSubmitVerificationCode)}
							className="space-y-6"
						>
							<FormField
