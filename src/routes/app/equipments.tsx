			...
			<div className="flex flex-col flex-1 overflow-hidden">
				...
				<div className="flex items-center justify-between border-b px-6 py-2">
					...
					<div className="flex items-center gap-2">
						<Tabs
							value={viewMode}
							onValueChange={(value) =>
								setViewMode(value as "table" | "grid" | "reservations")
							}
						>
							<TabsList>
								{isPrivilegedUser && (
								...
								return (
									<Card key={item.publicId} className="overflow-hidden">
										...
										<CardContent className="p-4">
													...
													<DropdownMenu>
														...
														<DropdownMenuContent align="end">
															...
															<DropdownMenuItem
																...
																onClick={() =>
																	handleDeleteEquipment(item.publicId)
																}
																disabled={isMutatingItem}
															>
											...
											{role?.includes("SUPER_ADMIN") && item.equipmentOwner && (
												<CardDescription className="text-xs mt-1">
				...
				{isPrivilegedUser && role && (
					<EquipmentFormDialog
						...
						isMutating={addMutation.isPending || editMutation.isPending}
